  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
        <div className=''>
            ...
            <p className='text-gray-400'>We offer a exchange policy to ensure your satisfaction with every purchase.</p>
        </div>
        <div className=''>
        ...
        <div className=''>
            ...
            <p className='text-gray-400'>We provide customer support on WhatsApp</p>
        </div>
    </div>
  )
}
